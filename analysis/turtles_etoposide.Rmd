...
turtle.eto.files <- turtle.eto.dir %>% 
  lapply(
    .,
    function(x){
      dir(
...
turtle.eto.df <- suppressWarnings(
  turtle.eto.files %>% 
    names %>% 
    lapply(
      .,
...
```{r}
turtle.rtg.eto.plot <- turtle.eto.df2 %>% 
